 ...
 */
const calculateCompletionRate = (allTasks, completedTasks) => {
 ...
 */
const calculateOverdueRate = async (userId, overdueTasks) => {
 ...
 */
const calculateAverageTaskAge = (tasksInPeriod) => {
 ...
 */
const calculateCreatedDoneRatio = (allTasks, completedTasks) => {
 ...
 */
const calculateMetrics = async (userId, period = '30d') => {
    try {
 ...
 */
const getRecommendations = async (userId, metrics) => {
