...
ENV NODE_ENV=production \
    ...
    PORT=3002 \
    TASKNOTETAKER_ALLOWED_ORIGINS="http://localhost:8080,http://localhost:3002,http://127.0.0.1:8080,http://127.0.0.1:3002" \
    TASKNOTETAKER_SESSION_SECRET="" \
    TASKNOTETAKER_USER_EMAIL="" \
    TASKNOTETAKER_USER_PASSWORD="" \
    TASKNOTETAKER_TRUST_PROXY=false \
    DISABLE_TELEGRAM=false \
    DISABLE_SCHEDULER=false \
    TASKNOTETAKER_UPLOAD_PATH="/app/backend/uploads" \
