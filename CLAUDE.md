...
23. **[MCP Integration](docs/14-mcp-integration.md)**
    ...
    - 64 tools across tasks, comments, projects, areas, goals, notes, tags, habits, people, views, inbox and search
...
- **MCP Integration:** AI tool connectivity via Model Context Protocol (64 tools)
